          ...
          <div className="max-w-2xl mx-auto -mt-10 flex flex-col lg:-mt-7">
            <form className="relative w-full">
              <label for="search-input" className="text-neutral-500 ">
                ...
                <input
                  type="search"
                  className="block w-full border-neutral-200 focus:outline-none border focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 bg-white  disabled:bg-neutral-200  rounded-full text-sm font-normal pl-14 py-5 pr-5 md:pl-16 shadow-lg "
                  id="search-input"
                  placeholder="Type your keywords"
                />
                <button
                  className="ttnc-ButtonCircle flex items-center justify-center rounded-full !leading-none disabled:bg-opacity-70 bg-slate-900 hover:bg-slate-800 text-slate-50 absolute right-2.5 top-1/2 transform -translate-y-1/2  w-11 h-11 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-6000 "
                  type="submit"
                >
