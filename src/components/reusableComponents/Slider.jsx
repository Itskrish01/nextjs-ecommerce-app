    ...
    <div className="mt-24 lg:mt-32">
      <div className="">
        ...
        >
          ...
          <SwiperSlide>
            <div className="relative  h-60 rounded-2xl overflow-hidden group bg-pink-100">
              <div>
                <div className=" absolute inset-5 sm:inset-8">
                  <img
          ...
          <SwiperSlide>
            <div className="relative w-full h-60 rounded-2xl overflow-hidden group bg-blue-50">
              <div>
                <div
